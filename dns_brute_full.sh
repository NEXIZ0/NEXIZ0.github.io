dns_brute_full () {
	...
	shuffledns -mode resolve -t 30 -silent -list $1.dns_gen -d $1 -r ~/.resolvers -m $(which massdns) | anew $1.dns_brute 2>&1 > /dev/null
	echo "[+] finished, total $(wc -l $1.dns_brute) resolved..."
}
